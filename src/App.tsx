  ...
  return (
      <div className="page-container no-select" style={{transform: "translate(-50%, -50%) scale(" + scale + ")"}}>
        <div className="page-wrapper">
          {
            board1.length === 10 ? <GameBoard board1={board1} {...{ board2, setBoard1, setBoard2, difficulty}}></GameBoard> : <SetupBoard {...{scale, setBoard1, difficulty, setDifficulty}}></SetupBoard>
          }
        </div>
      </div>
  );
